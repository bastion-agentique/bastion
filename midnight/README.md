...
```bash
git clone https://github.com/bastion-agentique/midnight-bastion.git
cd midnight-bastion
```
...
- [Bastion (Solana)](https://github.com/bastion-agentique/bastion)
- [Bastion EVM](https://github.com/bastion-agentique/bastion-evm)
