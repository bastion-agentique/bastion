...
const NAV_LINKS = [
  { label: 'Home',          href: '/' },
  { label: 'Docs',          href: 'https://github.com/bastion-agentique/midnight-bastion', external: true },
  { label: 'SDK',           href: 'https://github.com/bastion-agentique/midnight-bastion/tree/main/sdk', external: true },
            ...
            <li key={link.label}>
              {link.external ? (
                <a
                  ...
                  className="text-sm transition-opacity duration-150 hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] rounded"
